...
namespace riscv
{
	...
	// fmin/fmax leave the ±0 ordering implementation-defined. A single NaN
	// operand needs no help — std::fmin/fmax already return the other one —
	// but two NaN operands must produce the canonical qNaN.
