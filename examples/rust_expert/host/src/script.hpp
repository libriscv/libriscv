 ...
 * written in Rust changes nothing on this side.
 */
#include <functional>
...
struct Script
{
	...
	static constexpr gaddr_t  MAX_MEMORY     = 64ULL << 20;   // 64 MB
	static constexpr gaddr_t  STACK_SIZE     = 2ULL << 20;    // 2 MB
	static constexpr gaddr_t  MAX_HEAP       = 16ULL << 20;   // 16 MB
	static constexpr uint64_t MAX_BOOT_INSTR = 100'000'000ULL;
